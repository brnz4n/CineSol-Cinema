...
import { Popcorn, Mail, Lock, Smartphone } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 flex font-sans text-slate-300">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative overflow-hidden">
        ...
        <div className="w-full max-w-md bg-slate-900/80 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 sm:p-10 shadow-2xl relative z-10 animate-fade-in-up">
          ...
          <h2 className="text-4xl font-black text-white mb-8 text-center lg:text-left">Login</h2>
          ...
          <form className="space-y-5">
            ...
            <div className="flex items-center justify-between pt-2">
              <Link href="#" className="text-sm text-amber-400 hover:text-amber-300 hover:underline transition-colors font-medium">
                Esqueci minha senha
              </Link>
            </div>
          ...
          <p className="mt-8 text-center text-sm text-slate-400">
            Não tem uma conta?{' '}
            <Link href="/register" className="text-amber-400 font-bold hover:text-amber-300 hover:underline transition-colors">
              Cadastrar
            </Link>
          </p>
        </div>
